    ...
    public:
        ...
        void compareAge(Person &p){
            if (this->m_Age == p.m_Age){
                ...
                cout << "age mismatch!" << endl;
            }
        }

        /**
         * 如果没有&，那就是值返回，这里就会调用拷贝构造，而*this返回的相当于是一个新的对象
         * 所以对于值返回，就会造成在第一次调用中是对本体进行操作，但接着返回的是一个新的对象，一次类推
         * 
...
void test02(){
    ...
    //链式编程
    //因为这里的PlusAge返回的是一个对象本体，所以就可以一直不断的引用这个对象
    p3.PlusAge(10).PlusAge(10);
    p3.getAge();
