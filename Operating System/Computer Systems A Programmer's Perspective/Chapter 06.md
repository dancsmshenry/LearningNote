...
- <img src="image/存储器层次结构.png" style="zoom:200%;" />
...
- <img src="image/缓存管理.png" style="zoom:150%;" />
...
- <img src="image/高速缓存的通用组织.png" style="zoom:150%;" />
...
- 如果高速缓存正保存着地址A处那个字的副本，它就立即将那个字发回给CPU
  - <img src="image/高速缓存组织结构参数.png" style="zoom:150%;" />
  - 参数S，B将m个地址位分为三个字段
...
- <img src="image/直接映射高速缓存.png" style="zoom:150%;" />
...
- <img src="image/直接映射高速缓存中的组选择.png" style="zoom:150%;" />
...
- <img src="image/直接映射高速缓存中的行匹配.png" style="zoom:150%;" />
...
- <img src="image/为什么用中间的位来做索引.png" style="zoom:150%;" />
...
- <img src="image/组相联高速缓存.png" style="zoom:150%;" />
- 组选择
  - 和直接高速映射高速缓存的组选择一样
- 行匹配和字选择
  - 必须检查多个行的标记位和有效位，以确认所请求的字是否在集合中
  - <img src="image/组相联高速缓存中的组选择.png" style="zoom:150%;" />
  - 组中的任何一行都可以包含任何映射到这个组的内存块
  - 所以高速缓存必须搜索组中的每一行，寻找一个有效的行，其标记与地址中的标记相匹配
  - <img src="image/组相联高速缓存中的行匹配和字选择.png" style="zoom:150%;" />
- 行替换
...
- 是由一个包含所有高速缓存行的组组成的
- <img src="image/全相连高速缓存.png" style="zoom:150%;" />
- 组选择
  - 只有一个组，就直接选了
- 行匹配和字选择
  - <img src="image/全相联高速缓存中的行匹配和字选择.png" style="zoom:150%;" />
...
- <img src="image/core i7 的高速缓存层次结构.png" style="zoom:150%;" />
...
- <img src="image/存储器山.png" style="zoom:150%;" />
- 有点没读懂这幅图....
- 总结：
  - 存储器系统的性能不是一个数字就能描述的
