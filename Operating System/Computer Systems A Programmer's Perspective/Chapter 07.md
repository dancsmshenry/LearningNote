...
- <img src="image/典型的ELF可重定位目标文件.png" style="zoom: 200%;" />
...
- <img src="image/ELF可执行目标文件.png" style="zoom:150%;" />
...
- 每个linux程序都有一个运行时内存映像，代码段总时从地址0x400000处开始，后面是数据段
  ...
  - <img src="image/内存映像.png" style="zoom:150%;" />
...
- <img src="image/动态链接共享库.png" style="zoom:150%;" />
