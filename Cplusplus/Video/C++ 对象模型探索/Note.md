...
# 5-2 虚成员函数、静态成员函数调用方式（待）



# 5-3 虚函数地址问题的vcall引入（待）



# 5-4 静动态类型、绑定、坑点、多态体现深谈（待）



# 5-5 单继承虚函数趣味性测试和回顾（待）



# 5-6 多继承深释、第二基类，虚析构比加（待）
