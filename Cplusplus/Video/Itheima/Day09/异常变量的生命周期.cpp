...
class MyException{
    ...
    MyException(const MyException& e){
        cout << "MyException::MyException(const &)" << endl;
    }

    void func(){
        cout << "MyException::func()" << endl;
    }
...
void test01(){
    try{
        ...
        **/
         ...
         * 例如：e->func();
         * 这里语法插件没有报错，但是实际上在传进来之前就已经被释放掉了，所以无法调用，会报错
         * 
         * 解决办法：在堆上抛出对象，不过需要自己释放
         * 即delete e;
        **/

        // e->PrintError();//最好不要这么做，这是指向非法内存空间的
