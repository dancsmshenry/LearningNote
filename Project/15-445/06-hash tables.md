...
<img src="image/hash functions_02.png" style="zoom:150%;" />
...
占着被删除元素的位置（类似植物大战僵尸中的tombstone），但是不存放数据

如有查询就往后传递（这样的话，find的时候看到墓碑，就会继续往下找，而不是返回fail了）

<img src="image/linear probe hashing delete_01.png" style="zoom:150%;" />

<img src="image/linear probe hashing delete_02.png" style="zoom:150%;" />
...
<img src="image/movement_01.png" style="zoom:150%;" />

<img src="image/movement_02.png" style="zoom:150%;" />
...
<img src="image/robin hood hashing_03.png" style="zoom:150%;" />
...
<img src="image/cuckoo hashing_02.png" style="zoom:150%;" />
...
<img src="image/linear hashing_02.png" style="zoom:150%;" />
